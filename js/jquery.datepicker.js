    ...
    var DatePicker = function () {
            var ids = {},
                ...
                tpl = {
                    ...
                    ranges: ['<div class="datepickerRanges"><span>Periodo:</span>&nbsp;<select class="ranges"><option>Personalizado</option></select><p><input class="start" type="text" disabled="disabled"><span>-</span><input class="end" type="text" disabled="disabled">​</p><button class="btn" value="Aplicar fechas">​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​​Aplicar fechas</div>']
                },
                defaults = {
                    /**
                        ...
                        if (changed) {
                            ...
                            if (options.showRanges) {
                                if (options.textField && range[0] !== undefined && range[1] !== undefined) {
                                    $(options.textField + ' span').text(range[0].toString('dd/MM/yyyy') + ' - ' + range[1].toString('dd/MM/yyyy'));
                                }
                                // Apply changes when manuallyclicking a new range of dates
                                $('.datepickerRanges input.start').val(range[0].toString('dd/MM/yyyy'));
                                $('.datepickerRanges input.end').val(range[1].toString('dd/MM/yyyy'));
                ...
                initRanges = function (el, cal, ranges, onApplyFn, textField) {
                    ...
                    $select.change(function () {
                        ...
                        $ranges.find('input.start').val(range[0].toString('dd/MM/yyyy'));
                        $ranges.find('input.end').val(range[1].toString('dd/MM/yyyy'));
                    ...
                    $ranges.find('button').click(function () {
                        ...
                        if (textField && range[0] !== undefined && range[1] !== undefined) {
                            $(textField).text(range[0].toString('dd/MM/yyyy') + ' - ' + range[1].toString('dd/MM/yyyy'));
                        }
